...
public class P12 {
  ...
  public static int findPaths (String[][] g, ArrayList<String> e, ArrayList<String> r, int index) {
    int ans = 0;
    if (index == -1) {
      return 1;
    }
  ...
  public static void main(String[] args) throws IOException {
    ...
    //System.out.println(elements);
    int ans = findPaths(graph,elements,restricted,s);
